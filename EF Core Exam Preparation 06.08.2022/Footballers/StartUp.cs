...
namespace Footballers
{
    public class StartUp
    {
        ...
        {
            var exportCoachesWithTheirFootballers = Serializer.ExportCoachesWithTheirFootballers(context);
            ...
            //var exportTeamsWithMostPlayers = Serializer.ExportTeamsWithMostFootballers(context, dateTime);
